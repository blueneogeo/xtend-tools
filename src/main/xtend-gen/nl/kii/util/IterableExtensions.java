...
public class IterableExtensions {
  ...
  public static <T extends Object> ImmutableList<T> concat(final Iterable<? extends T> list, final Iterable<? extends T> values) {
    ...
    if (_notEquals) {
      ...
      ImmutableList.Builder<T> _addAll_1 = _addAll.addAll(values);
      _xifexpression = _addAll_1.build();
    } else {
      throw new NullPointerException("concat: passed values are null");
    }
    return _xifexpression;
  }
  ...
  public static <T extends Object> ImmutableList<T> concat(final T value, final Iterable<T> list) {
    ...
    if (_notEquals) {
      ...
      throw new NullPointerException("concat: passed list is null");
    }
    return _xifexpression;
  }
  ...
  public static <T extends Object> ImmutableList<T> concat(final Iterable<? extends T> list, final T value) {
    ...
    if (_notEquals) {
      ...
      throw new NullPointerException("concat: passed value is null");
    }
    return _xifexpression;
  }
  ...
  public static <T extends Object> ImmutableSet<T> concat(final T value, final Set<T> set) {
    ImmutableSet<T> _xifexpression = null;
    boolean _notEquals = (!Objects.equal(set, null));
    if (_notEquals) {
      ImmutableSet.Builder<T> _builder = ImmutableSet.<T>builder();
      ...
      throw new NullPointerException("concat: passed set is null");
    }
    return _xifexpression;
  }
   ...
   */
  public static <T extends Object> T any(final Iterable<? extends T> values) {
    T _xblockexpression = null;
    {
      int _size = org.eclipse.xtext.xbase.lib.IterableExtensions.size(values);
